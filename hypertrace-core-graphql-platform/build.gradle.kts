...
dependencies {
  constraints {
    ...
    api("org.hypertrace.core.grpcutils:grpc-context-utils:0.3.3")
    api("org.hypertrace.core.grpcutils:grpc-client-utils:0.3.3")
    api("org.hypertrace.gateway.service:gateway-service-api:0.1.54")
    ...
    api("io.grpc:grpc-api:1.35.0")
    api("io.grpc:grpc-core:1.35.0")
    api("io.grpc:grpc-stub:1.35.0")
    api("io.grpc:grpc-context:1.35.0")
